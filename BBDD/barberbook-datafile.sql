...
-- Password para todos los usuarios: SuperAdmin123!
...
use barberbook;
UPDATE users 
SET password_hash = '$2b$10$hv5oMu5hbP9mGW2ZUE5ib.R//Ly3kL24O8hlbviHic299P1EsgZj6'
WHERE id <> 1;
